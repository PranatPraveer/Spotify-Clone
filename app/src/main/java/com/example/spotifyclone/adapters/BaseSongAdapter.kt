...
abstract class BaseSongAdapter(
    ...
    inner class SongViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        var tvPrimary: TextView? = itemView.findViewById(R.id.tvPrimary)
        var tvSecondary: TextView? = itemView.findViewById(R.id.tvSecondary)
        var ivItemImage: ImageView? = itemView.findViewById(R.id.ivItemImage)
